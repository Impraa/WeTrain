// icon:tick-outline | Typicons https://www.s-ings.com/typicons/ | Stephen Hutchings
import * as React from "react";

function IconTickOutline(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      baseProfile="tiny"
      viewBox="0 0 24 24"
...
export default IconTickOutline;
